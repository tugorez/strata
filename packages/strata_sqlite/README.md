...
import 'migrations.g.dart'; // Generated migrations
...
- **Automatic code generation** creates type-safe migration classes
...
- ✅ Support for WHERE clauses with multiple operators (`=`, `!=`, `<`, `>`, `<=`, `>=`)
